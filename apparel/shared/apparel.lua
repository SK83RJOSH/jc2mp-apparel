...
ApparelBase.RegisteredApparel = {
	...
	["Grey Kepi With Wig"] = ApparelBase("pd_tourist_female1.eez/pd_tourist_female-h_keps.lod", ApparelBase.Templates.Head),
	...
	["Light-Grey Bandana With Black Stripes"] = ApparelBase("pd_generic_male_1.eez/pd_generic_male_1-hat_linen.lod", ApparelBase.Templates.Head),
