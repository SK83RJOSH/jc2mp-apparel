...
ApparelBase.RegisteredApparel = {
	...
	["Flight Helmat"] = ApparelBase("pd_gov_elite.eez/pd_govnewfix_elite-helmet.lod", ApparelBase.Templates.Head),
	["Grey Bandana With Black Stripes"] = ApparelBase("pd_ms_doorman.eez/pd_doorman-h_bandana.lod", ApparelBase.Templates.Head),
	...
	["Japanese Helmat"] = ApparelBase("pd_ms_japaneseveterans.eez/pd_ms_japaneseveterans-helmet.lod", ApparelBase.Templates.Head),
	["Police Cap"] = ApparelBase("pd_panaupolice.eez/panaupolice-cap.lod", ApparelBase.Templates.Head),
	["Police Helmat"] = ApparelBase("pd_panaupolice.eez/panaupolice-helmet.lod", ApparelBase.Templates.Head),
	...
	["Grey Kepi"] = ApparelBase("pd_oilplatform_male1.eez/pd_oilplatform_male-greycap.lod", ApparelBase.Templates.Head),
	...
	["Light-Grey Bandana With White Stripes"] = ApparelBase("pd_generic_male_3.eez/pd_generic_male_3-hat_linen.lod", ApparelBase.Templates.Head),
